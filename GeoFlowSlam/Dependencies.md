...
* All code in **GMS** folder.
This is a modified version of [GMS](https://github.com/JiawangBian/GMS-Feature-Matcher). All files included are BSD licensed.

* All code in **small_gicp** folder.
This is a modified version of [small_gicp](https://github.com/koide3/small_gicp). [MIT license](https://en.wikipedia.org/wiki/MIT_License).
