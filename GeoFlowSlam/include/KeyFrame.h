...
class KeyFrame {
 ...
 public:
  ...
  // void GetTrackFeaturePoints(std::vector<std::shared_ptr<feature_pt>>&
  // vFeaturePoints); Image
  ...
  pcl::PointCloud<PointType>::Ptr mpPointCloudDownsampled;
