...
class Settings {
 public:
  ...
  Eigen::Matrix3f getRodom2cam(){return eigenRodom2cam_;}
  bool insertKFsWhenLost() { return insertKFsWhenLost_; }

  float depthMapFactor() { return depthMapFactor_; }

  bool useOpticalFlow() { return enableOpticalFlow_; }
  std::string cameraModel() { return mCameraModel_; }
  bool useClahe() { return enableClahe_; }
  float timeRecentlyLost() { return timeRecentlyLost_; }
  float GetKfInsertInterval() { return kfInsertInterval_; }
  ...
  std::string lidarConfigFile() { return lidarConfigFile_; }
  ...
  void set_imu_method(int method) {
    ...
    imuInitMethod_ = method;
  }
  int getImuInitMethod() { return imuInitMethod_; }
  int get_fast_init() { return fast_init_; }
  int get_sensor() { return sensor_; }
  int getLKWinsize() { return lkWinsize_; }
  float get_F_THRESHOLD() { return F_THRESHOLD_; }
  int get_MASK_THRESHOLD() { return MASK_THRESHOLD_; }
  int enableGMSInit() { return enableGMSInit_; }
  int enableAsync() { return enableAsync_; }
  int enableICPLoop() { return enableICPLoop_; }
  int enableICPLocalBA() { return enableICPLocalBA_; }
  int enableLidarLocalBA() { return enableLidarLocalBA_; }
  int enableViewer() { return enableViewer_; }
  float downsizeResolution() { return downsizeResolution_; }
  // float get_imu_init_time() { return 10.0; }
  int useICP() { return enableICP_; }
  int imageDownsample() { return imageDownsample_; }
  int useLidarObs() { return useLidarObs_; }
  int iterMax() { return iterMax_; }
  std::string getICPMethod() { return icpMethod_; }
  int enableRobotOdom() { return enableRobotOdom_; }
 ...
 private:
  ...
  float imuFrequency_;
  Sophus::SE3f Tbc_;
  Eigen::Matrix3f eigenRodom2cam_;
  ...
  int enableOpticalFlow_;
  int enableClahe_;

  float timeRecentlyLost_;

  float kfInsertInterval_;
  std::string mCameraModel_;
  ...
  float globalResolution_, localResolution_;
  ...
  int enableICP_;
  int enableICPLoop_;
  int enableICPLocalBA_;
  int enableLidarLocalBA_;
  int enableViewer_;
  int imageDownsample_;
  float downsizeResolution_;
  int useLidarObs_;
  int iterMax_;
  int enableRobotOdom_;
  std::string extractor_tpye_;
  std::string lidarConfigFile_;
  std::string icpMethod_;
};
};  // namespace ORB_SLAM3
