...
class LocalMapping {
 public:
  ...
  // LocalMapping(System* pSys, Atlas* pAtlas, const float bMonocular, bool
  // bInertial, const string &_strSeqName=std::string());
  LocalMapping(System* pSys, Atlas* pAtlas, Settings* settings,
 ...
 protected:
  ...
  void InitializeIMU(float priorG = 1e2, float priorA = 1e6,
                     bool bFirst = false, bool bFastInit = false);
